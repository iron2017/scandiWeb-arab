...
export function ListItem({ id, sku, name, price, type, description }: ListItemProps) {
    ...
    return (
        <Card style={{ width: "40wh", height: "30vh", boxShadow: "0 1px 6px rgb(0,0,0,0.35)" }}>
            ...
            <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                ...
                <Row className="d-flex text-center">
                    ...
                    <Col className="col-12" style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
